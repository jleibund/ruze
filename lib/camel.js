...
define([ 'node-uuid', 'events', 'underscore', 'requirejs'], function(uuid, events, _, requirejs){
    ...
    var singleton = (function () {
        ...
        camel.load = function (name, callback, container) {
            ...
            var cb = function callbackComponentContinue(comp, cont) {
                cps[name] = comp;
                callback(comp);
            }
        ...
        camel.endpoint = function(end, cb){
            var r = new route(this);
            if (!this.routes) this.routes = {};
            this.routes[end] = r;
            return r.to(end, cb);
        }
        camel.send = function(routeId, body, cb){
          return camel.from(routeId, function(exchange){
                exchange.out = body;
