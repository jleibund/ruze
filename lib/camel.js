...
define(function(require) {
    ...
    var uuid = require('node-uuid'), events = require('events'), _ = require('underscore'), $ = require('jquery');
    ...
    var localloader = function(){
        this.paths = ['./plugin'];
        this.addPath = function(path) {this.paths.push(path)};
        this.load = function(name,cb){
            _.each(this.paths, function(p){
                var comp = require(p+'/'+name+'/index');
                if (comp) cb(comp,'local');
            },this)
        };
    };
    ...
    var remoteloader = function(){
        this.paths = {};
        this.addPath = function(container,path) {this.paths[container]=path};
        this.load = function(name,cb){
