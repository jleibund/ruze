...
define([ 'node-uuid', 'events', 'underscore', 'q', 'cutils'], function(uuid, events, _, Q, cutils){
    ...
    route.fn.to = function (arg) {
        var ep = this.parseEndpoint(Array.prototype.slice.call(arguments,0));
    ...
    route.fn.add = function(ep,instance){
        ep.prior = (!this.route.length)? _.extend({}, init_endpoint, {id:this.startEvent()}) : _.last(this.route);
    ...
    route.fn.parseEndpoint = function parseEndpoint(arg) {
        ...
        ep.id = ep.component+':'+ep.object+'?'+cutils.normalize(arg);
        return ep;
    };
...
//                return Q.fcall(definition(next))
//            });
        }
...
//                if (comp) return Q.fcall(function(){return 'cream'});
     ...
     */
        camel.fn.parseEndpoint = function (arg) {
            ...
            return {component:component, container:container, object:object, args:obj};
        }
