...
//                                        var toProcess = _.extend({},sequence);
//                                        toProcess.shift();
                                        ...
                                        instance.consume(function (err, e) {
                                            ...
                                            e.process = _.clone({},cur.process[id]);
                                            e.process.shift();
                                    ...
                                    // setup processing, if necessary
//                                    if (first == cur.config.id){
//                                        exchange.toProcess = _.extend({},sequence);
//                                    }
