...
define([ 'require', 'q', 'node-uuid', 'events', 'underscore', 'colors', 'cutils', 'remotecomponent',
    ...
    function (require) {
        ...
        var uuid = require('node-uuid'), events = require('events'), _ = require('underscore'),
            Q = require('q'), colors = require('colors'), exprjs = require('exprjs'), remotecomponent = require('remotecomponent'),
            localloader = require('localloader'), remoteloader = require('remoteloader');
