        ...
        ruze.fn._buildRecipientsAndEvents = function (strategy) {
            ...
            _.each(strategy.computed, function (computed, id) {
                ...
                if (!this.routes[id]) {
                    ...
                    // todo:  exchange needs to know what route its on
                    // todo:  first endpoint of the route must set the route id in the exchange.
                    // todo:  last endpoint of the route must kick if off to any other route recipients and create exchanges with those route ids
