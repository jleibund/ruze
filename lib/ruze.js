...
//                                    .then(promise).then().done();
        ...
        this.load = Q.nfbind(function(strategy,cb) {
            cb(null,strategy)
        });
        this.configure = Q.nfbind(function(strategy,cb) {
            cb(null,strategy)
        });
        this.create = Q.nfbind(function(strategy,cb) {
            cb(null,strategy)
        });
    };
