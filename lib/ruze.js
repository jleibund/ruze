...
//                                    toPush[subroute.id] = {route:subroute, endpoint:entryRC.endpoint};
...
//                                _.each(_.values(toPush), function(v){
//                                    v.route.route.push(v.endpoint);
//                                    v.route.computed.push(v.endpoint);
//                                    v.route.sequence.push(v.endpoint);
//                                },this);
                                fn({id: ruze.id})
                            });
                        } else {
...
//                        if (curContainer == 'local') allRemote = false;
                        curRun.push(curEp);
...
//                            runs.route[runs.route.length-1].terminate = true;
                        ...
                        placeholder.push([]);
//                        if (bestContainer == 'local') allRemote = false;
...
//                if ((runNewKickoff || !exchange.process.length) && !_.contains(exchange.done, id)){
//                    delete exchange.process;
//                    exchange.done.push(id);
//                    if (runNewKickoff)
